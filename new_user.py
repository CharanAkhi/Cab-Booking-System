...
Label(interface,text="GENDER",font='cambria').place(x=150,y=200)
Radiobutton(interface, text="MALE",padx = 20, variable=gender,value=1,font='cambria').place(x=325,y=200)
Radiobutton(interface, text="FEMALE",padx = 20, variable=gender, value=2,font='cambria').place(x=450,y=200)
