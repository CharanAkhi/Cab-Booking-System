...
Entry(interface,textvar=location,font='cambria',bd=2).place(x=150,y=100)
Label(interface,text="DESTINATION: ",font='cambria').place(x=15,y=150)
Entry(interface,textvar=destination,font='cambria',bd=2).place(x=150,y=150)
Label(interface,text="COST: ",font='cambria').place(x=15,y=200)
Entry(interface,textvar=cost,font='cambria',bd=2).place(x=150,y=200)
Label(interface,text="TIME: ",font='cambria').place(x=15,y=250)
Entry(interface,textvar=time,font='cambria',bd=2).place(x=150,y=250)
Label(interface,text="DISTANCE: ",font='cambria').place(x=15,y=300)
Entry(interface,textvar=distance,font='cambria',bd=2).place(x=150,y=300)
